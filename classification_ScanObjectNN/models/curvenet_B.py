...
class Walk(nn.Module):
    ...
    def forward(self, xyz, x, adj, cur):
        ...
        # batch flattened indices for the starting points
        ...
        for step in range(self.curve_length):
            ...
            # if step == 0:
            #     # get starting point features using flattend indices （获取起始点特征）
            ...
            # pre_feature_expand = pre_feature
...
class CurveNet_B(nn.Module):
    def __init__(self, num_classes=15, k=20, setting='default'):
        super(CurveNet_B, self).__init__()
