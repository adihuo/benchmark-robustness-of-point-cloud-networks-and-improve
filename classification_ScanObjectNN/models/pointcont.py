...
class Backbone(nn.Module):
    def __init__(self, patch_dim=[3, 64, 128, 256, 512, 1024], dropout=0.5, num_classes=40, num_points=1024, down_ratio=[2, 4, 8, 16, 32], patch_size=[16, 16, 16, 16, 16], local_size=[16, 16, 16, 16, 16], num_heads=4):
        super().__init__()
        self.nblocks = 6 - 1
...
class PointConT_cls(nn.Module):
    def __init__(self, patch_dim=[3, 64, 128, 256, 512, 1024], dropout=0.5, num_classes=15, num_points=1024, down_ratio=[2, 4, 8, 16, 32], patch_size=[16, 16, 16, 16, 16], local_size=[16, 16, 16, 16, 16], num_heads=4):
        super().__init__()
        self.backbone = Backbone(patch_dim=[3, 64, 128, 256, 512, 1024], dropout=0.5, num_classes=40, num_points=1024, down_ratio=[2, 4, 8, 16, 32], patch_size=[16, 16, 16, 16, 16], local_size=[16, 16, 16, 16, 16], num_heads=4)
